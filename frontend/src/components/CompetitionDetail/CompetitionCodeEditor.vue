  ...
  >
    <header class="contest-editor__toolbar">
      ...
      <div class="editor-actions">
        <label class="sr-only" for="competition-language">选择提交语言</label>
        <select id="competition-language" v-model="language" class="form-select form-select-sm language-select" :disabled="!languageOptions.length">
...
function canRunExample() {
  return props.problemId !== null && props.problemId !== undefined && props.problemId !== ''
}
