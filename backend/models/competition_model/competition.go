...
type Competition struct {
	...
	Visibility   int8    `json:"visibility" gorm:"column:visibility;type:tinyint;not null;default:1;comment:1公开 2非公开"`
	PasswordHash *string `json:"password_hash" gorm:"column:password_hash;type:varchar(255);comment:非公开竞赛密码哈希"`
