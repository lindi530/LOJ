<template>
  <article class="content-card">
    ...
    <section v-else-if="activeTab === 'submissions'" class="content-card__panel content-card__panel--flush" aria-label="竞赛提交记录">
      <CompetitionSubmissions
        :competition-id="competition.id"
      />
    </section>

    <section v-else class="content-card__panel content-card__panel--flush" aria-label="竞赛榜单内容">
...
import CompetitionRankingBoard from './CompetitionRankingBoard.vue'
...
.content-card__panel.content-card__panel--flush {
  padding: 0;
}
